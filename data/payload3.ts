...
export const payload: IInput[] = [
  ...
  },
  {
    ...
    id: '1',
    ants: [
      { id: 1, wasted: 0, age: 14, health: 7, payload: 7, point: { x: 2, y: 0 }, event: 'birth' },
      { id: 17, wasted: 4, age: 1, health: 4, payload: 0, point: { x: 1, y: 1 }, event: 'good' },
      { id: 18, wasted: 4, age: 1, health: 4, payload: 0, point: { x: 3, y: 1 }, event: 'birth' },
    ],
    canvas: {
      cells: [
        [{}, {}, new CM(7, 1), new CM(2, undefined, 1)],
